...
<i>Structure of the COL1 protein. Signal peptide is not shown. Propeptides are indicated by a gray bar. Enlarged areas of the spectra show the start of the mature peptide, the N-terminal telopeptide, and the start of the helical region. Tryptic cut sites are highlighted in yellow. Marker peptides are indicated by pink boxes. Image from <a href="https://doi.org/10.1016/j.jprot.2020.104041">Brown et al. 2021</a>.</i> 
